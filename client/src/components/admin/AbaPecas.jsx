        ...
        <div>
          ...
          {modalMidias.carregando ? (<div className="carregando-container" style={{ padding: '24px 0' }}><div className="spinner" /><p>Carregando mídias...</p></div>
            ...
            {modalMidias.fotos.map((foto, index) => (
              <div key={foto.id} style={{ display: 'flex', flexDirection: 'column', borderRadius: 'var(--raio-lg)', overflow: 'hidden', border: index === 0 ? '2px solid var(--cor-primaria)' : '1px solid var(--cor-borda)', background: 'var(--cor-fundo-card)', boxShadow: index === 0 ? '0 0 12px rgba(13, 189, 173, 0.3)' : 'none', transition: 'all var(--transicao-rapida)' }}>
